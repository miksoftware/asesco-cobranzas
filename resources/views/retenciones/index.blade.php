                                        ...
                                        <div class="flex items-center justify-center gap-1 relative">
                                            ...
                                            <template x-if="abono.soporte">
                                                <div class="flex items-center gap-1">
                                                    <button type="button" @click="openSoporteModal(abono.soporte)" class="text-green-600 hover:bg-green-50 p-1.5 rounded transition-colors cursor-pointer" title="Ver soporte">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                                    </button>
                                                    <button type="button" @click="downloadSoporte(getSoporteUrl(abono.soporte), getSoporteFileName(abono.soporte))" class="text-blue-600 hover:bg-blue-50 p-1.5 rounded transition-colors cursor-pointer" title="Descargar soporte">
